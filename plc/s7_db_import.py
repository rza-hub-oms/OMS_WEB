# plc/s7_db_import.py
"""
Turns a TIA Portal DB source export into ready-to-use OMS S7 addresses
(DB1.DBX0.0, DB1.DBW4, ...), so the Mapping panel can offer a picker
instead of the user typing each address by hand.
...
def parse_db_source(text, db_number=None):
    """Parses TIA Portal "Generate source" DB text.
    ...
    # Find the outermost STRUCT ... END_STRUCT body.
    struct_start = None
